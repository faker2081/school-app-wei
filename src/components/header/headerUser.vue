      ...
      <template #center>
        <view class="center-box">
          <view class="user-info">
            <uv-avatar v-if="postInfo.userPhotoUrl" size="35" :src="baseUrl + postInfo.userPhotoUrl" mode="aspectFill"></uv-avatar>
            <uv-avatar v-else size="35" mode="aspectFill"></uv-avatar>
